...
namespace ursine
{
	namespace AK
	{
		...
		AKSOUNDENGINEDLL_API void SoundEngine::ExitSoundEngine()
		{
#ifndef AK_OPTIMIZED
			Comm::Term();
#endif // AK_OPTIMIZED
		...
		AKSOUNDENGINEDLL_API void SoundEngine::UpdateSoundEngine()
		{
			...
			AkExternalSourceInfo* SE_ExternalSources, AkPlayingID SE_PlayingID)
		{
			...
			AkPlayingID playingID = AK::SoundEngine::PostEvent(SE_eventID,
				...
				SE_ExternalsCount, SE_pExternalSources, SE_PlayingID);
		...
		AKSOUNDENGINEDLL_API AKRESULT SetBasePath(const AkOSChar* BasePath)
		{
			return m_lowLevelIO.SetBasePath(BasePath);
		}

		AKSOUNDENGINEDLL_API AKRESULT SetBankPath(const AkOSChar* BankPath)
		{
			return m_lowLevelIO.SetBankPath(BankPath);
		}

		AKSOUNDENGINEDLL_API AKRESULT SetAudioSrcPath(const AkOSChar* AudioSourcePath)
		{
