	...
	namespace graphics
	{
		namespace ufmt_loader
		{
			MaterialInfo::MaterialInfo() :
				type(FbxMaterial::Type_None),
				ambitype(Material_Eles::Fac_None),
				difftype(Material_Eles::Fac_None),
				emistype(Material_Eles::Fac_None),
				spectype(Material_Eles::Fac_None),
