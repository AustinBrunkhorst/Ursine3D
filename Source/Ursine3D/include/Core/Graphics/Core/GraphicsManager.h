...
namespace ursine
{
    ...
    private:
        ...
        void RenderPointLight(_DRAWHND handle, GFXCamera &currentCamera, SMat4 &proj);
        void RenderDirectionalLight(_DRAWHND handle, GFXCamera &currentcamera);
        void RenderPrimitive(_DRAWHND handle);
        void RenderDebugPoints(const SMat4 &view, const SMat4 &proj, GFXCamera &currentCamera);
        void RenderDebugLines(const SMat4 &view, const SMat4 &proj, GFXCamera &currentCamera);
