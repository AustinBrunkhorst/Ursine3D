...
macro (ursine_project PROJECT_NAME)
    ursine_parse_arguments(
        PROJ 
        "FOLDER;TYPE;SOURCE_DIR;INCLUDE_DIR;DEPENDS;PCH_NAME;SYM_LINKS;INSTALLER_VERSION;INSTALLER_SUMMARY;INSTALLER_DISPLAY_NAME;WINDOWS_RESOURCE_FILE;INSTALLER_ICON;INSTALLER_UNINSTALL_ICON;SUBSYSTEM_DEBUG;SUBSYSTEM_RELEASE;META_HEADER;META_MODULE_HEADER;META_FLAGS;META_DEPENDENCIES;COPY_SHADERS" 
    ...
    if ("${PROJ_BUILD_META}" STREQUAL "TRUE")
        ursine_prebuild_meta(
            SOURCE_ROOT ${CMAKE_CURRENT_SOURCE_DIR}/${PROJ_INCLUDE_DIR}
            HEADER_FILES ${FILES_INC}
            OUT_GENERATED_DIR META_GENERATED_DIR
            OUT_GENERATED_FILES META_GENERATED_FILES
            OUT_FILES_INC FILES_INC
            OUT_FILES_SRC FILES_SRC
