...
#define FMOD_VERSION    0x00010316
...
#define FMOD_INIT_ASYNCREAD_FAST             0x00200000 /* Rather than setting FMOD_ASYNCREADINFO::result, call FMOD_ASYNCREADINFO::done to enable a semaphore based wait inside fmod, rather than the older method which can incur up to 10ms delay per read. */
/* [DEFINE_END] */
...
[
    ...
    Use System::setAdvancedSettings and the resamplerMethod member to tell FMOD the resampling quality you require for FMOD_SOFTWARE based sounds.
