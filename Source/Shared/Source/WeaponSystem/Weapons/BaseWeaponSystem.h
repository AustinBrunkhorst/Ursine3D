...
private:
    ...
    bool RaycastClosestHitLogic(int indexOfObjHit, ursine::ecs::EntityHandle& ObjHit, ursine::SVec3& raycastVec, ursine::physics::RaycastOutput& rayout, AbstractHitscanWeapon& weapon);
