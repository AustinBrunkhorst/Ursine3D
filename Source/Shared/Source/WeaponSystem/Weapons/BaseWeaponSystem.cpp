...
namespace
{
    ...
    void ProjectileVelocity( AbstractProjWeapon& weapon, ursine::ecs::Entity& proj, ursine::ecs::Transform& trans)
    {
...
void BaseWeaponSystem::FireProjectileWeapon(AbstractProjWeapon& weapon, ursine::ecs::EntityUniqueID id)
{
    if ( weapon.FireLogic( ) )
    {
