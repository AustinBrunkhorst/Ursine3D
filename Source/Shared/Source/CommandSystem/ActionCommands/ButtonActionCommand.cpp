...
/////////////////////////////////////////////////////////////////////
ButtonActionCommand::ButtonActionCommand(PlayerAction* action, ursine::ecs::Entity* owner)
    : m_action(action)
    , m_owner(owner)
{
}
...
ButtonActionCommand::ButtonActionCommand(PlayerAction* action, ursine::ecs::Entity* owner, Interactions& methods)
    : m_action(action)
    , m_owner(owner)
...
{
    m_interactionMethods.push_back(interaction);
    return *this;
}
