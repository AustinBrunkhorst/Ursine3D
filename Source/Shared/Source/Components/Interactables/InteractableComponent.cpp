...
void Interactable::StartInteraction(const CommandQueue* queue, ursine::ecs::EntityUniqueID id)
{
    (m_interaction->*m_startFunc)( queue, id );
}

void Interactable::Interact(const CommandQueue* queue, ursine::ecs::EntityUniqueID id)
{
    ( m_interaction->*m_interactFunc )( queue, id );
}

void Interactable::StopInteraction(const CommandQueue* queue, ursine::ecs::EntityUniqueID id)
{
