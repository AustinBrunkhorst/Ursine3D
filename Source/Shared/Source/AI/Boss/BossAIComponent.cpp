...
void BossAI::SetPollinateGooFloorEntityName(const std::string &name)
{
    m_pollinateGooFloor = name;

    NOTIFY_COMPONENT_CHANGED( "pollinateGooFloorEntityName", m_pollinateGooFloor );
}
