...
void PhysicsTest::onMouseScroll(EVENT_HANDLER(MouseManager))
{
...
void PhysicsTest::UpdateCamera_Mouse(float dt)
{
    auto *app = Application::Instance;
...
void PhysicsTest::UpdateCamera(float dt)
{
    auto *app = Application::Instance;
    auto *keyboardMgr = app->GetCoreSystem<KeyboardManager>();
...
void PhysicsTest::initGraphics(void)
{
    ...
    mouseManager->Listener(this).On(MM_SCROLL, &PhysicsTest::onMouseScroll);
