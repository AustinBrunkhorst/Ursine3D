    ...
    : m_project( project )
{
    m_project->GetScene( ).GetWorld( ).Listener( this )
        ...
        .On( ecs::WORLD_ENTITY_EDITOR_COMPONENT_CHANGED, &EditorEntityManager::onComponentChanged );
}
...
EditorEntityManager::~EditorEntityManager(void)
{
    m_project->GetScene( ).GetWorld( ).Listener( this )
        ...
        .Off( ecs::WORLD_ENTITY_EDITOR_COMPONENT_CHANGED, &EditorEntityManager::onComponentChanged );
}
