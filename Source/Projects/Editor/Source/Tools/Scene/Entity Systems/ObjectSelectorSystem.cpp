...
void ObjectSelectorSystem::OnInitialize()
{
    ...
    m_world->Listener(this)
        ...
        .On(ursine::ecs::WorldEventType::WORLD_ENTITY_COMPONENT_ADDED, &ObjectSelectorSystem::onSelectedAdd);
...
void ObjectSelectorSystem::onSelectedAdd(EVENT_HANDLER(ursine::ecs::World))
{
...
void ObjectSelectorSystem::pickObject(const ursine::ecs::EntityUniqueID id)
{
    ...
    auto transf = obj->GetComponent<ecs::Transform>();
